...
public class ProgramacaoController {
    ...
    private static final String PROGRAMACAO_URL = "https://programacao.netcombo.com.br/gatekeeper/exibicao/select?q=id_revel:%s&wt=json&rows=%d&sort=id_canal asc,dh_inicio asc&fq=dh_inicio:[%s TO %s]";
